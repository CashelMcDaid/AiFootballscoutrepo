...
const playerCardPriceBand = document.getElementById("playerCardPriceBand");
const playerCardValueForMoney = document.getElementById("playerCardValueForMoney");
const playerCardUndervalued = document.getElementById("playerCardUndervalued");
const playerCardExplanation = document.getElementById("playerCardExplanation");
...
async function openPlayerCard(playerId) {
  ...
  playerCardValue.textContent = moneyCard(player.estimatedMarketValue);
  playerCardPriceBand.textContent = player.priceBand || "N/A";
  playerCardValueForMoney.textContent = player.valueForMoneyScore || 0;
  playerCardUndervalued.textContent = player.undervaluedScore || 0;
  playerCardExplanation.textContent = player.explanation || "Built from age, role, league and current output.";
